...
Output: data_real_14x12/baseline_tariffs_2022.csv
"""
...
NEW8 = ["VNM", "THA", "MYS", "IDN", "SGP", "PHL", "IND", "MEX"]
...
def main() -> None:
    ...
    ahs = ind[(ind["year"] == 2022) & (ind["tariff_type"] == "AHS_WGHTD")]
    ...
    row_ahs = float(ahs[~ahs["reporter_iso3"].isin(
        EU27 + ["CHN", "USA", "JPN", "KOR"] + NEW8)]["duty_value"].mean()) / 100
