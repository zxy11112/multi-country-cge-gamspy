...
(prepare_real_data_6x12.py); differences:
  ...
  - services shares come from data_real_14x12/services_flows_batis_2022.csv
...
COMTRADE_EXP = ROOT / "整理" / "02_清洗" / "clean_comtrade_sitc_2022_expansion.csv"
...
def main() -> None:
    ...
    agg: dict[str, dict] = {}
    for reg in ["CHN", "USA", "JPN", "KOR", "VNM", "THA", "MYS", "IDN",
                "SGP", "PHL", "IND", "MEX"]:
